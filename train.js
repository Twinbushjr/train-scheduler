$( document ).ready(function() {
  ...
  var config = {
    apiKey: "AIzaSyCjGocBtbcezXd44NfsXnUz-_n5n5tJBhg",
    authDomain: "train-scheduler-7a3be.firebaseapp.com",
    databaseURL: "https://train-scheduler-7a3be.firebaseio.com",
    projectId: "train-scheduler-7a3be",
    storageBucket: "",
    messagingSenderId: "945757106083"
  };
    // Initialize Firebase
